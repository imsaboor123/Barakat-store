...
const Readytocook = () => {
      ...
      fetch('/menu.json')
        ...
        .then((data) => {
          ...
          if (Array.isArray(data.categories)) {
            const bulkBuyCategory = data.categories.find((cat) => cat.category === 'Ready to cook');
            if (bulkBuyCategory) {
   ...
   <>
       <div className="md:max-w-screen-2xl md:container md:mx-auto md:px-10 lg:px-20 px-2">
        <div className="">
            <div className="">
                <img src="/images/Ready to cook/WebBannerAED-25E1.gif" alt="" />
            </div>
            <div className="mt-10">
                <img src="/images/Ready to cook/EWfreshdip2.jpg" alt="" />
            </div>
        </div>

           {/* Ready to cook */}
        <div className="pt-5">
          <h2 className="text-md md:text-xl font-bold">Ready to cook</h2>
